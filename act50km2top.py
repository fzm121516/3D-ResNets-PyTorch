...
def process_video(model, spatial_transform, video_path, images_dir, args):
    ...
    return highest_count, total_clips, has_walking, is_walking_video
...
def main():
    ...
    with ThreadPoolExecutor(max_workers=args.num_workers) as executor:
        ...
        for future in as_completed(futures):
            highest_count, num_clips, has_walking, is_walking_video = future.result()
    ...
    if total_videos:
        walking_video_percentage = (walking_videos / total_videos) * 100
